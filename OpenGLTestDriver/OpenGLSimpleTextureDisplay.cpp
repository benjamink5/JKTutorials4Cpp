...
#include "OpenGLSimpleTextureDisplay.h"

#include "OpenGLSimpleTexture.h"

#include <gl\GLU.h>

OpenGLSimpleTextureDisplay::OpenGLSimpleTextureDisplay(void)
{
...
bool OpenGLSimpleTextureDisplay::Init(HWND hWnd)
{
...
void OpenGLSimpleTextureDisplay::Resize(int width, int height)
{
	if (!((OpenGLContext*)m_pContext)->GetRenderContext())
	{
		return;
...
void OpenGLSimpleTextureDisplay::Render()
{
	if (!((OpenGLContext*)m_pContext)->GetRenderContext())
	{
		return;
