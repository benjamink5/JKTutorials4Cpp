#include "StdAfx.h"
#include "OpenGLPBOTextureDisplay.h"
...
OpenGLPBOTextureDisplay::OpenGLPBOTextureDisplay(void)
{
	m_pContext = new OpenGLContext();
	m_pTexture = new OpenGLPBOTexture();
...
OpenGLPBOTextureDisplay::~OpenGLPBOTextureDisplay(void)
{
	...
	{
		m_pTexture->Unload();
		delete (OpenGLPBOTexture*)m_pTexture;
		m_pTexture = NULL;
	}
...
bool OpenGLPBOTextureDisplay::Init(HWND hWnd)
{
...
void OpenGLPBOTextureDisplay::Resize(int width, int height)
{
	if (!((OpenGLContext*)m_pContext)->GetRenderContext())
	{
		return;
...
void OpenGLPBOTextureDisplay::Render()
{
	if (!((OpenGLContext*)m_pContext)->GetRenderContext())
	{
		return;
